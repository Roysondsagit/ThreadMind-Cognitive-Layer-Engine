  ...
  return (
    <div className="max-w-5xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-700">
      <div className="text-center space-y-4">
        <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-emerald-50 text-emerald-600 text-xs font-black uppercase tracking-widest border border-emerald-100">
          <MessageCircle size={14} className="mr-2" />
          No App Required
        </div>
        <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">Connect Your Brain to <span className="text-emerald-500">WhatsApp</span></h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-[40px] border border-slate-100 p-10 shadow-sm space-y-10">
          <div className="space-y-8">
            <div className="flex items-start space-x-6">
              <div className="w-12 h-12 rounded-2xl bg-slate-900 text-white flex items-center justify-center font-black shrink-0">1</div>
              <div className="flex-1">
                <h4 className="text-xl font-black text-slate-900 mb-2">Save the Bot Number</h4>
                <div className="flex items-center space-x-3 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                  <span className="font-mono font-bold text-lg text-slate-700">{botNumber}</span>
                  <button 
                    onClick={copyNumber}
                    className="ml-auto p-2 hover:bg-white rounded-xl transition-all text-indigo-600"
                  >
            ...
            <div className="flex items-start space-x-6">
              <div className="w-12 h-12 rounded-2xl bg-slate-900 text-white flex items-center justify-center font-black shrink-0">2</div>
              <div className="flex-1">
                <h4 className="text-xl font-black text-slate-900 mb-2">Send Any Link</h4>
            ...
            <div className="flex items-start space-x-6">
              <div className="w-12 h-12 rounded-2xl bg-slate-900 text-white flex items-center justify-center font-black shrink-0">3</div>
              <div className="flex-1">
                <h4 className="text-xl font-black text-slate-900 mb-2">Receive AI Summary</h4>
                <p className="text-slate-500 font-bold leading-relaxed">
          ...
          <div className="pt-6 border-t border-slate-50">
            <div className="flex items-center justify-between p-6 bg-indigo-50 rounded-[32px]">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="font-black text-indigo-900">Scan QR to chat</p>
                </div>
              </div>
              <button className="bg-white p-3 rounded-full text-indigo-600 shadow-sm hover:scale-110 transition-transform">
                <ArrowRight />
              </button>
            </div>
          </div>
        ...
        {/* WhatsApp Simulator */}
        <div className="bg-slate-900 rounded-[50px] p-4 shadow-2xl relative overflow-hidden flex flex-col h-[650px]">
          <div className="absolute top-0 inset-x-0 h-16 bg-slate-800 flex items-center px-8 border-b border-slate-700/50">
          ...
          <div className="flex-1 p-6 space-y-4 overflow-y-auto mt-16 scrollbar-hide">
            {simLog.map((log, i) => (
          ...
          <div className="p-4 bg-slate-800 border-t border-slate-700/50">
            <div className="flex items-center space-x-3 bg-slate-900 p-2 pl-4 rounded-full border border-slate-700">
              <input 
                type="text"
                value={simInput}
                ...
                className="bg-transparent border-none focus:ring-0 text-white text-sm font-bold flex-1"
              />
              <button 
