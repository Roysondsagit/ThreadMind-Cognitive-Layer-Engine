    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {Object.values(Category).map(cat => (
          <div key={cat} className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm">
            <div className="flex justify-between items-start mb-4">
              {getMetricIcon(cat)}
              <span className="text-2xl font-black text-slate-800">{categoryCounts[cat] || 0}</span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm">
          <h3 className="text-xl font-black mb-8 text-slate-900 tracking-tight">Category Distribution</h3>
          <div className="h-64">
        ...
        <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm flex flex-col justify-center items-center text-center">
          ...
          <h3 className="text-xl font-black mb-2 text-slate-900 tracking-tight">Cognitive Load</h3>
